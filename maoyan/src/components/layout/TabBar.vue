<template>
    <div class="app-tab-bar">
        <ul>
            <router-link tag = 'li' active-class='active' keep-alive to='/movie'>
            ...
            <router-link tag = 'li' active-class='active' keep-alive to='/theatre'>
            ...
            <router-link tag = 'li' active-class='active' keep-alive to='/mine'>
